...
public class UserService: IUserService
{
    ...
    public async Task<UserDto> RegisterAsync(RegisterDto registerDto)
    {
        ...
        if (!result) throw new Exception("Kullanıcı kaydedilemedi.");

        return _mapper.Map<UserDto>(user); // UserDto döndürülüyor
    }
    ...
    public async Task<bool> UpdateUserAsync(UserDto userDto)
    {
        ...
        _mapper.Map(userDto, user); // DTO'dan user modeline dönüşüm
